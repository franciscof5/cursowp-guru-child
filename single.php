<?php get_header();
	...
	while(have_posts()): the_post();
	  ...
	  if($page_layout != "content-full-width") {
		$feature_image = "blog-onecolumn-sidebar";
	  }
	  else {
                      ...
                      <article id="post-<?php the_ID(); ?>" <?php post_class('blog-post'); ?>>
                          <div class="post-details"><?php
                              if(isset($meta_set['disable-date-info']) == ""): ?>                
                                  <div class="date"><p><span><?php echo get_the_date('d'); ?></span><br /><?php echo get_the_date('M'); ?><br /><?php echo get_the_date('Y'); ?></p></div><?php
                              endif;
                          ...
                          <div class="post-content">
                              ...
                              <div class="entry-thumb">
                                  ...
                                  <?php if( $format === "image" || empty($format) ):
										  ...
										  elseif($pholder != "true"): ?>
                                              <img src="http<?php dt_theme_ssl(true);?>://placehold.it/840x340&text=<?php the_title(); ?>" alt="<?php the_title(); ?>" /><?php
										  endif;
